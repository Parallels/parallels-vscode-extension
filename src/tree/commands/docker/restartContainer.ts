...
export function registerRestartDockerContainerCommand(
      ...
      vscode.window.withProgress(
        ...
        async () => {
          try {
            ...
            await DockerService.containerOp(DockerContainerOperation.Restart, currentVm.ID, item.id.replace(currentVm.ID,""))
              .then(result => {
                if (result) {
