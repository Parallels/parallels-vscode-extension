...
export async function processVmInfoIntensions(userPrompt: string, vmInfo: string,  context: vscode.ChatContext, model: vscode.LanguageModelChat, token: vscode.CancellationToken): Promise<CopilotUserIntension[]> {
